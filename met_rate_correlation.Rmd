...
for (correlation_result_metric in result_names_list){
  ...
  for (var in vars_to_compare){
    ...
    print(correlation_result_metric)
    print(wilcox_p_val)
   ...
   # Calculate x and y range of the plot
...
subplot_title <- ggdraw() + draw_label(paste('Significance of partial correlation with lifespan after \ncorrecting for somatic mutation rate',num_samples,'resamples'),size = 20,fontface='bold') #
